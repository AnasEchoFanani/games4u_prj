            ...
            <div class="card text-center">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-add-to-shop fw-bold" type="button"><i class='bx bx-plus-circle'></i> ADD TO WISHLIST</button>
                        <hr class="text-white">
                        <div class="row text-aligne">
                            ...
                            <div class="text-end col-6 text-white"><i class="fa-brands fa-playstation"></i></div>
