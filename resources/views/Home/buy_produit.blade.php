...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="row">
                ...
                <div id="carouselExampleCaptions" class="carousel slide">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <video src="images_site/1234.mp4" type="video/*" class="d-block w-100" alt="..." controls
                                   autoplay muted>
                            </video>
                        </div>
            ...
            <div class="col-lg-3 col-md-2 col-sm-3 col-xs-2">
                <div class="short-div">
                    <a type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" aria-current="true"
                       aria-label="Slide 1">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <button class="btn btn-add-to-shop fw-semibold btn-lg" type="button">ADD TO CART</button>
                            ...
                            <div class="row text-aligne">
                                ...
                                @elseif($product_id->devices == "pc")
                                    <div class="text-end col-6 text-white"><i class='bx bxl-apple'></i>&nbsp;<i
                                            class='bx bxl-windows'></i></div>
                                @elseif($product_id->devices == "console")
                                    <div class="text-end col-6 text-white"><i class="fa-brands fa-playstation"></i>&nbsp;<i
