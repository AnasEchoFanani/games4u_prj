                    ...
                    <div class="card-body">
                        ...
                        <form action="/authentication/login_go" method="POST" class="mt-5 text-white" id="form">
                            ...
                            <div class="row">
                                ...
                                <div class="row mt-4">
                                    <div class="col d-grid gap-2 col-4 mx-auto"><button class="btn btn-buy btn-lg" id="submit_s" type="submit">Sign In</button></div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col text-center">Don't have an account ? <a href="/authentication/register" class="more-link">Register</a></div>
                                </div>
