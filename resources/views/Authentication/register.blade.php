                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control bg-dark text-white" id="First_Name" name="First_Name">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-outline-secondary" type="button" id="btn_Password"><i class='bx bx-show'></i></button>
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control bg-dark text-white" id="Last_Name" name="Last_Name">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="Password" class="form-control bg-dark text-white" id="Confirm_password" name="Confirm_password">
                                            <button class="btn btn-outline-secondary" type="button" id="btn_Confirm_password"><i class='bx bx-show'></i></button>
                                        </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col d-grid gap-2 col-4 mx-auto"><button class="btn btn-buy btn-lg" id="submit_s" type="submit">Sign up</button></div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col text-center">Already have an Account ? <a href="/authentication/login" class="more-link">Sign in</a></div>
                                </div>
