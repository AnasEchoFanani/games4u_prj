                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="game name" name="game_name"
                                           id="game_name" value="{{$p->game_name}}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" id="info_game" name="info_game" rows="4" cols="50"
                                              placeholder="info game" required>{{$p->info_game}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Prix DH" id="price_game"
                                           name="price_game" value="{{$p->price_game}}" required>
                                </div>
                                <div class="col-md-3 mb-3">
                                                ...
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text"
                                                               ...
                                                               name="Système_dexploitation_min"
                                                               value="{{$p->Système_dexploitation_min}}" required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div>
                                                        ...
                                                        <input class="form-control" type="text" id="Processeur_min"
                                                               name="Processeur_min" value="{{$p->Processeur_min}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Mémoire_vive_min"
                                                               name="Mémoire_vive_min" value="{{$p->Mémoire_vive_min}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Graphiques_min"
                                                               name="Graphiques_min" value="{{$p->Graphiques_min}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="DirectX_min"
                                                               name="DirectX_min" value="{{$p->DirectX_min}}" required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Espace_disque_min"
                                                               ...
                                                               value="{{$p->Espace_disque_min}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text"
                                                               ...
                                                               name="Système_dexploitation_max"
                                                               value="{{$p->Système_dexploitation_max}}" required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Processeur_max"
                                                               name="Processeur_max" value="{{$p->Processeur_max}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Mémoire_vive_max"
                                                               name="Mémoire_vive_max" value="{{$p->Mémoire_vive_max}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Graphiques_max"
                                                               name="Graphiques_max" value="{{$p->Graphiques_max}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="DirectX_max"
                                                               name="DirectX_max" value="{{$p->DirectX_max}}" required>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="Espace_disque_max"
                                                               ...
                                                               value="{{$p->Espace_disque_max}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
