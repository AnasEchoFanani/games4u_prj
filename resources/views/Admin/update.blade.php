                ...
                <div class="card p-4 bg-dark text-white border border-white">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="game name" name="game_name" id="game_name" value="{{$p->game_name}}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control" type="date" id="date" name="date" value="{{$p->date}}" >
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="genre" class="form-label">genre <span class="text-danger">*</span></label>
                            <select class="form-select" name="genre" id="genre">
                                <option selected disabled value="">{{$p->genre}}</option>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="Système_dexploitation_min" name="Système_dexploitation_min" value="{{$p->Système_dexploitation_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label for="Processeur_min" class="form-label">Processeur min</label>
                                                <input class="form-control" type="text" id="Processeur_min" name="Processeur_min" value="{{$p->Processeur_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Mémoire_vive_min" class="form-label">Mémoire_vive_min</label>
                                                <input class="form-control" type="text" id="Mémoire_vive_min" name="Mémoire_vive_min" value="{{$p->Mémoire_vive_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Graphiques_min" class="form-label">Graphiques_min</label>
                                                <input class="form-control" type="text" id="Graphiques_min" name="Graphiques_min" value="{{$p->Graphiques_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="DirectX_min" class="form-label">DirectX_min</label>
                                                <input class="form-control" type="text" id="DirectX_min" name="DirectX_min" value="{{$p->DirectX_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Réseau_min" class="form-label">Réseau_min</label>
                                                <input class="form-control" type="text" id="Réseau_min" name="Réseau_min" value="{{$p->Réseau_min}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Espace_disque_min" class="form-label">Espace_disque_min</label>
                                                <input class="form-control" type="text" id="Espace_disque_min" name="Espace_disque_min" value="{{$p->Espace_disque_min}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="Système_dexploitation_max" name="Système_dexploitation_max" value="{{$p->Système_dexploitation_max}}"  required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Processeur_max" class="form-label">Processeur_max</label>
                                                <input class="form-control" type="text" id="Processeur_max" name="Processeur_max" value="{{$p->Processeur_max}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Mémoire_vive_max" class="form-label">Mémoire_vive_max</label>
                                                <input class="form-control" type="text" id="Mémoire_vive_max" name="Mémoire_vive_max" value="{{$p->Mémoire_vive_max}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Graphiques_max" class="form-label">Graphiques_max</label>
                                                <input class="form-control" type="text" id="Graphiques_max" name="Graphiques_max" value="{{$p->Graphiques_max}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="DirectX_max" class="form-label">DirectX_max</label>
                                                <input class="form-control" type="text" id="DirectX_max" name="DirectX_max" value="{{$p->DirectX_max}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Réseau_max" class="form-label">Réseau_max</label>
                                                <input class="form-control" type="text" id="Réseau_max" name="Réseau_max" value="{{$p->Réseau_max}}" required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="mb-3">
                                                <label for="Espace_disque_max" class="form-label">Espace_disque_max</label>
                                                <input class="form-control" type="text" id="Espace_disque_max" name="Espace_disque_max" value="{{$p->Espace_disque_max}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
